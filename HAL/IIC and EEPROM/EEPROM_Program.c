...
void EEPROM_voidSend4Numbers(uint16 Copy_uint16LocationAddress, uint8* Array_Recieve_Str)
{
...
void EEPROM_voidRead4Numbers(uint16 Copy_uint16LocationAddress, uint8* Array_Recieve_Str)
{
	uint8 *local_ptrArr= Array_Recieve_Str;
	int i=0;
	for(i=0;i<4;i++)
